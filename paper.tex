...
(i.e. the sum of delays from excitatory to inhibitory and from inhibitory to excitatory neuron). Here we show that this specific pattern
...
that underlie development of orientation maps in primary visual cortex. We demonstrate this statement analytically under simplifying conditions, 
